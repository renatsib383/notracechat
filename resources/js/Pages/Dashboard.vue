    ...
    <AuthenticatedLayout>
        ...
        <div class="py-12">
            <div class="mx-auto max-w-7xl sm:px-6 lg:px-8">
                ...
                <div v-for="message in messages" :key="message.user_id" class="relative overflow-hidden bg-white shadow-sm sm:rounded-lg mb-3">
                    <div v-if="message.text.length > 0">
                        <span class="absolute top-0 left-0 text-gray-500 text-sm p-2">{{ message.username }}</span>
                    <div class="pt-7 pb-3 px-3 text-gray-900">
                        {{ message.text }}
                    </div>
                    </div>
                </div>
